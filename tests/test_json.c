...
int main(void) {
    ...
    DeusString strings[] = {{"https://example.invalid/data", 28u}, {"$.x", 3u}};
    DeusInstruction code[] = {{DEUS_GENESIS, 0u, 0}, {DEUS_HUNT, 0u, 0}, {DEUS_JSON_PATH, 1u, 0}, {DEUS_HALT, 0u, 0}};
    DeusProgram program = {strings, 2u, code, 4u}, decoded = {0};
    ...
    int opcode_ok = decoded.code_count == 4u && decoded.code[2].opcode == DEUS_JSON_PATH && decoded.code[2].operand == 1u;
