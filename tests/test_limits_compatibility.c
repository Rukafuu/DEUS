...
static void test_frozen_public_contract(void) {
    static const struct {
        ...
        {DEUS_LOAD, 0x10}, {DEUS_CONST_NULL, 0x11},
        {DEUS_CONST_BOOL, 0x12}, {DEUS_CONST_I64, 0x13},
        {DEUS_URL_ENCODE, 0x14}, {DEUS_URL_JOIN, 0x15},
        ...
        {DEUS_RECORD_GET_OPTIONAL, 0x1E},
        {DEUS_LIST_AT_OPTIONAL, 0x1F}, {DEUS_EQUAL, 0x20},
        {DEUS_NOT_EQUAL, 0x21}, {DEUS_LESS, 0x22},
        {DEUS_LESS_EQUAL, 0x23}, {DEUS_GREATER, 0x24},
        {DEUS_GREATER_EQUAL, 0x25}, {DEUS_BOOL_AND, 0x26},
        {DEUS_BOOL_OR, 0x27}, {DEUS_BOOL_NOT, 0x28},
        {DEUS_COALESCE, 0x29}, {DEUS_TO_TEXT, 0x2A},
        {DEUS_TO_I64, 0x2B}, {DEUS_TO_BOOL, 0x2C}
    };
    size_t index;
    _Static_assert(DEUS_ABI_VERSION == 1u, "bytecode ABI changed");
    _Static_assert(DEUS_HOST_ABI_VERSION == 1u, "host ABI changed");
