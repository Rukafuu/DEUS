...
typedef enum {
    ...
    DEUS_CONST_I64 = 0x13, DEUS_URL_ENCODE = 0x14,
    DEUS_URL_JOIN = 0x15, DEUS_HUNT_VALUE = 0x16,
    DEUS_JSON_PATH = 0x17, DEUS_CONST_RECORD = 0x18,
    DEUS_CONST_LIST = 0x19, DEUS_RECORD_SET = 0x1A,
    DEUS_LIST_PUSH = 0x1B, DEUS_RECORD_GET = 0x1C,
    DEUS_LIST_AT = 0x1D, DEUS_RECORD_GET_OPTIONAL = 0x1E,
    DEUS_LIST_AT_OPTIONAL = 0x1F, DEUS_EQUAL = 0x20,
    DEUS_NOT_EQUAL = 0x21, DEUS_LESS = 0x22, DEUS_LESS_EQUAL = 0x23,
    DEUS_GREATER = 0x24, DEUS_GREATER_EQUAL = 0x25,
